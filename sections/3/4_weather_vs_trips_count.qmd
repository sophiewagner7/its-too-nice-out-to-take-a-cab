...
df |>
  ...
  geom_smooth(method = "loess", se = T, color = secondary_color, alpha=0.15) +
...
Here we see our first possible indication of “nice”: it is not nice when it is 30° outside. Additionally, 
we see a pronounced dip at 20°, suggesting that is a great time for walking. It is neither too hot, nor too cold.  

...
### Variations in ridership: rush hour analysis

To better understand ridership trends, we next analyzed volume of trips by hour for each day of the week. 
...
**Conclusion**: Moving forward, we'll restrict the analysis to non-holiday weekday rush hour periods (7-9 AM and 5-7 PM) to reduce variability and emphasize patterns tied to commuting behavior.
...
Even within the weekday rush hour subset, ridership varies... We see that mondays have the lowest average trip count and narrowest variability. I tie this to the fact that Monday is a common WFH day (explaining lower average) and people tend to be consistent at the start of the week. Tuesday through Thursday we see a pretty consistent average and IQR. Friday we see the highest variability, likely because people engage in social activities after work. 

Looking at the trend by month, we can see that july and august have the lowest average ridership. I would say that this is a seasonal trend - lower in the summer months. Perhaps this is because there is less commuting because people go on summer vacations, but perhaps this is also related to warmer weather. January is also low, maybe indicating continued end-of-year holidays and vacations. February through June is fairly consistent.

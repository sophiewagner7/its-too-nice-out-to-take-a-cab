...
Logic: Morning commuters may be more rigid about travel (like going to office) compared to evening commuters (leisure or flexible activities). 
```{r}
#| fig-width: 10
#| fig-height: 5
...
(p1 + p2 +
  ...
  plot_annotation(title = NULL) ) & theme(legend.position = "bottom") 
```

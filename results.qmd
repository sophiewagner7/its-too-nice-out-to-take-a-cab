...
First, we can see when the Pandemic hit in March, 2020. The "start" of the pandemic in the US is generally considered to have taken place mid-March (March 17, 2020) [cite], and we do in fact see ridership fall by approximately half that of February. In April 2020, when large-scale shutdowns were firmly in place, we see the lowest ridership of the entire period. 
...
As mentioned previously, we suspected that cab usage returned to somewhat of a normal around October 2021. The calendar view of taxi usage provides support to that argument.
```{r}
#| fig-width: 10
df |> 

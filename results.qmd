...
### when did the pandemic end? (perh part of previous section.)

goal: get rid of pandemic data.
...
## Patterns in weather data? - Moacir

Yes. Use filtered Data. We are telling a story here that is taking a trip.

  Just by month.

  - temp - min/max/avg per month? - candlestick
  - rain - number of rainy days per month - bar chart
  - clouds - number of ovc/broken/etc. days per month - stacked bar chart
...
{{< include sections/3/weeks_vs_months.qmd >}}


{{< include sections/3/time_shift.qmd >}}
